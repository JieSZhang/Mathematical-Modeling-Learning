...
(2)np.random.uniform生成均匀分布的随机数
(3)np.random.randn生成标准正态的随机数
(4)np.random.randint生成随机的整数
(5)np.random.normal生成生态分布
(6)np.random.shuffle随机打乱顺序
(7)np.random.seed设置随机数种子
(8)random_sample生成随机的浮点数